...
public final class ActivityNewsDetailsBinding implements ViewBinding {
  ...
  private ActivityNewsDetailsBinding(@NonNull ConstraintLayout rootView, @NonNull WebView webView) {
  ...
  public static ActivityNewsDetailsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityNewsDetailsBinding((ConstraintLayout) rootView, webView);
    }
